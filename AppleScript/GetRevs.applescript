...
tell application "Microsoft Excel"
	tell active sheet to tell used range to set drawURLS to value of cell ("E1:E" & (count of rows))
	tell active sheet to tell used range to set specURLS to value of cell ("G1:G" & (count of rows))
end tell
...
repeat with i from 1 to (length of drawURLS)
	...
	set cmd to "curl --anyauth -u morganel:Password17 " & (item i of specURLS)
